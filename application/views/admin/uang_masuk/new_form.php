   ...
   <?php if ($this->session->flashdata('success')): ?>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <a href="<?php echo site_url('admin/Uang_masuk/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
          </div>
          <div class="card-body">

            <form action="<?php base_url('admin/Uang_masuk/add') ?>" method="post" enctype="multipart/form-data" >
